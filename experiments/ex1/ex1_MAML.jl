...
args1 = Dict("gen" => "gridworld", "n_traj" => 0, "params" => false, "bias" => 0.0, "perm" => false)
...
for e in 0:n_epochs
    ...
    @printf("Epoch:  %-6d\n", e)
    if (e % 1000) == 0
       	bson("models/ex1/maml_v2/"*string(e)*".bson", model=m)
    end
...
bson("results/ex1/maml_v1.bson", means_t=means_t, cis_t=cis_t, 
