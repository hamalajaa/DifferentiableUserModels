...
data_gen = NeuralProcesses.DataGenerator(MCTSPlanner(args;),
...
for e in 1:n_epochs
    ...
    if (e % 1000) == 0
    	bson("../../models/ex1/transformer_v1/"*string(e)*".bson", model=m)
    end
...
using BSON
bson("../../results/ex1/v3_transformer.bson", means_t=means_t, cis_t=cis_t, 
