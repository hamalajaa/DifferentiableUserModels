...
data_gen = NeuralProcesses.DataGenerator(SearchEnvSampler(args;),
...
for e in 1:n_epochs
	...
	if (e % 1000) == 0
		   bson("../../models/ex2/transformer_v1/"*string(e)*".bson", model=m)
	end
...
bson("../../results/ex2/transformer_v1.bson", means_t=means_t, cis_t=cis_t, 
