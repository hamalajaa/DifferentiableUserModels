...
args1 = Dict("gen" => "menu_search", "n_traj" => 10, "params" => false, "p_bias" => 0.0, "perm" => false)

data_gen = NeuralProcesses.DataGenerator(SearchEnvSampler(args1;),
...
for e in 0:n_epochs
	...
	if (e % 1000) == 0
		   bson("models/ex2/mlp_v1/"*string(e)*".bson", model=m)
	end
...
bson("../../results/ex2/mlp_v1.bson", means_t=means_t, cis_t=cis_t, 
